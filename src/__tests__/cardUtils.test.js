...
describe('isCardRemovable', () => {
  ...
  it('allows person entities to be removed from header', () => {
    expect(
      isCardRemovable('person.john', 'header', { getCardSettingsKey: identity, cardSettings: {} })
    ).toBe(true);
  });

  it('disallows non-person entities from header', () => {
    expect(
      isCardRemovable('sensor.temp', 'header', { getCardSettingsKey: identity, cardSettings: {} })
    ).toBe(false);
  });

  it('disallows car removal from settings page', () => {
    expect(
      isCardRemovable('car', 'settings', { getCardSettingsKey: identity, cardSettings: {} })
    ).toBe(false);
  });

  it('disallows media_player removal from settings', () => {
    expect(
      isCardRemovable('media_player.speaker', 'settings', {
  ...
  it('allows other cards to be removed from settings', () => {
    expect(
      isCardRemovable('sensor.temp', 'settings', { getCardSettingsKey: identity, cardSettings: {} })
    ).toBe(true);
  });
  ...
  it('allows removable-prefix cards on any page', () => {
    ...
    prefixes.forEach((prefix) => {
      expect(
        isCardRemovable(`${prefix}test`, 'home', { getCardSettingsKey: identity, cardSettings: {} })
      ).toBe(true);
    });
  });
  ...
  it('allows entity-type cards via settings', () => {
    ...
    expect(
      isCardRemovable('sensor.temp', 'home', {
        getCardSettingsKey: identity,
  ...
  it('allows toggle-type cards via settings', () => {
    ...
    expect(
      isCardRemovable('switch.lamp', 'home', {
        getCardSettingsKey: identity,
        cardSettings: settings,
      })
    ).toBe(true);
  ...
  it('allows media_player card to be removed from non-settings pages', () => {
    expect(
      isCardRemovable('media_player', 'home', { getCardSettingsKey: identity, cardSettings: {} })
    ).toBe(true);
  });
...
describe('isCardHiddenByLogic', () => {
  ...
  it('hides media_player (singular) always', () => {
    expect(
      isCardHiddenByLogic('media_player', {
        activePage: 'home',
        getCardSettingsKey: identity,
        cardSettings: {},
        entities: {},
  ...
  it('hides media_group_ with no valid entities', () => {
    ...
    expect(
      isCardHiddenByLogic('media_group_1', {
        activePage: 'home',
        getCardSettingsKey: identity,
        cardSettings: settings,
        entities: {},
  ...
  it('hides non-existent entities on settings page', () => {
    expect(
      isCardHiddenByLogic('sensor.temp', {
        activePage: 'settings',
        getCardSettingsKey: identity,
        cardSettings: {},
        entities: {},
  ...
  it('does not hide special cards even if no entity exists', () => {
    expect(
      isCardHiddenByLogic('calendar_card_1', {
        activePage: 'home',
        getCardSettingsKey: identity,
        cardSettings: {},
        entities: {},
  ...
  it('hides non-special cards without entity', () => {
    expect(
      isCardHiddenByLogic('switch.unknown', {
        activePage: 'home',
        getCardSettingsKey: identity,
        cardSettings: {},
        entities: {},
  ...
  it('uses mapped entityId for visibilityCondition checks', () => {
    expect(
      isCardHiddenByLogic('weather_temp_1', {
        activePage: 'home',
        getCardSettingsKey: identity,
        cardSettings: {
          weather_temp_1: {
  ...
  it('uses configured entity key mappings for special cards', () => {
    expect(
      isCardHiddenByLogic('climate_card_living', {
        activePage: 'home',
        getCardSettingsKey: identity,
        cardSettings: {
          climate_card_living: {
    ...
    expect(
      isCardHiddenByLogic('switch.lamp', {
        ...
        cardSettings: {
          'switch.lamp': {
            visibilityCondition: {
              rules: [{ type: 'state', states: ['off'], forSeconds: 10 }],
            },
          },
        },
        entities: {
