...
export function useCardRendering({
  ...
  setShowEnergyModal: legacySetShowEnergyModal,
  setActiveVacuumId,
  ...
  const moveCardInArray = useCallback(
    (cardId, direction) => {
      ...
      [pageCards[currentIndex], pageCards[newIndex]] = [
        pageCards[newIndex],
        pageCards[currentIndex],
      ];
